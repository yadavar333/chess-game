...
# Create database directory if it doesn't exist (for SQLite only)
os.makedirs("data", exist_ok=True)

# Database URL - read from environment variable or default to SQLite
DATABASE_URL = os.getenv("DATABASE_URL", "sqlite:///./data/chess_game.db")
